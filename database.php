...
class Db {
     ...
     * 
     * @param string $query The query string containing placeholders
     * @return mysqli_stmt|false Returns a prepared statement object on success or false on failure
     */
