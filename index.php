...
<section id="News">
    ...
    <div class="news-grid">
        ...
        <div class="news-item2">
            ...
            <p>We're thrilled to announce the opening of our newest restaurant in Bugibba! Our team has been working tirelessly to bring you a dining experience like no other. From the stunning decor to the delectable menu, every detail has been carefully crafted to delight your senses. We can't wait to welcome you to our new location!</p>
            <img src="images/bugibba.jpeg" alt="Bugibba">
        </div>
    </div>
</section>
{% endblock %}
